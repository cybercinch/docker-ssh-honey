FROM alpine:3.12
RUN apk add --no-cache git tzdata libssh-dev screen gcc musl-dev nano openssl build-base bash openssh geoip curl netcat-openbsd clang json-c-dev libssh2-dev
